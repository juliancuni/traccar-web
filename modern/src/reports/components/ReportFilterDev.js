...
import {
  FormControl, InputLabel, Select, MenuItem, Button, TextField, Typography, RadioGroup, FormControlLabel, Radio,
} from '@mui/material';
...
const ReportFilterDev = ({ children, handleSubmit, handleSchedule, showOnly }) => {
  ...
  return (
    <div className={classes.filter}>
      <RadioGroup defaultValue="single" row>
        <FormControlLabel value="single" control={<Radio />} onChange={handleRadio} label="Single" title="Single Device Select" />
        <FormControlLabel value="multi" control={<Radio />} onChange={handleRadio} label="Multi" title="Multi Device Select" />
        <FormControlLabel value="group" control={<Radio />} onChange={handleRadio} label="Group" title="Group Select" />
      </RadioGroup>
      {!ignoreDevice && (
...
export default ReportFilterDev;
