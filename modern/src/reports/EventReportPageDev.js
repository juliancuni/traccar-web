...
import ReportFilterDev from './components/ReportFilterDev';
      ...
      <div className={classes.container}>
        ...
        <div className={classes.containerMain}>
          <div className={classes.header}>
            <ReportFilterDev handleSubmit={handleSubmit} handleSchedule={handleSchedule}>
...
export default EventReportPageDev;
